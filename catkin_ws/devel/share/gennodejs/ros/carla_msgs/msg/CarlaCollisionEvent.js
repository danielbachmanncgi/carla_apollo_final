...
class CarlaCollisionEvent {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.other_actor_id, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.other_actor_id = _deserializer.int32(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'b8f348767da2990ae4fa75f403fe585c';
  }
